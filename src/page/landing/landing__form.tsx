...
export function LandingPageForm({
  ...
  const handleLandingPageFormSubmit = async (
    inputsValid: boolean,
  ...
  return (
    <Form name="landingPageForm" handleSubmit={handleLandingPageFormSubmit}>
      {({ inputErrors, register }: any) => {
        ...
        return (
          <div
            className={styles.landingFormContainer}
            data-testid={LANDING_FORM_TEST_ID}
          >
            ...
            <fieldset className="form-fieldset">
              <input
                className={`${styles.landingFormInput} ${
                  inputErrors["name"] && styles.landingFormInputError
                }`}
                name="name"
                type="text"
            ...
            <fieldset className="form-fieldset">
              <input
                className={`${styles.landingFormInput} ${
                  inputErrors["email"] && styles.landingFormInputError
                }`}
                name="email"
                type="email"
                placeholder="Email"
            ...
            <fieldset className="form-fieldset">
              <input
                className={`${styles.landingFormInput} ${
                  inputErrors["confirmEmail"] && styles.landingFormInputError
                }`}
                name="confirmEmail"
                type="email"
              ...
              />
              <div>
                {inputErrors["confirmEmail"] && inputErrors["confirmEmail"]}
              </div>
              {emailsMatch !== undefined && (
                <div>{!emailsMatch && "emails do not match"}</div>
              )}
            </fieldset>
